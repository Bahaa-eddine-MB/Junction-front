...
const Kids = () => {
  ...
  return (
    <>
      <Layout>
        <main className="px-20 overflow-hidden">
          <Image src={text} alt="text" className="m-4 relative "></Image>
          <div className="relative w-full h-[400px] my-4 ">
            ...
            <Image
              src={item3}
              alt="e"
              className="absolute bottom-8 -left-[4px]  -rotate-6 "
            />
            <div className="w-[80%] relative  max-w-[700px] mx-auto  md:h-[300px] h-[200px] drop-shadow shadow-xl rounded-2xl my-24">
              ...
              <div className="w-1/2 absolute right-0 h-full flex flex-col justify-start py-4 gap-12 items-center px-2">
                <div>
                  ...
                  <p className="my-2">
                    Enjoy this game in order to improve your skills Enjoy this
                    game in order to improve your skills Enjoy this game in
                    order to improve your skills
                  </p>
                </div>
                <button
                  type="submit"
                  className="text-white   bg-pink-300 hover:bg-pink-500 focus:ring-4 focus:outline-none focus:ring-pink-300 font-medium rounded-3xl text-sm px-8 py-2 "
                >
                  JOIN
                </button>
              </div>
              <Image
                src={item1}
                alt="e"
                className="absolute -top-24 -right-12  -rotate-45 "
              />
            </div>
          </div>

          <div className="my-4">
            <p className="ml-4 text-[#073946] font-semibold text-2xl ">
            ...
            <div className="flex items-center justify-center my-4">
              <button
                type="submit"
                className="text-white   bg-yellow-500 hover:bg-yellow-700 focus:ring-4 focus:outline-none focus:ring-yellow-500 font-medium  text-sm px-24 py-4 "
              >
                More
              </button>
            </div>
