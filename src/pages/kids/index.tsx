...
const Kids = () => {
  ...
  return (
    <>
      <Layout>
        <Image src={text} alt="text" className="ml-4 relative"></Image>
            ...
            <div className="w-1/2 absolute right-0 h-full flex flex-col justify-start py-4 gap-12 items-center px-2">
              <div>
                ...
                <p className="my-2">
                  ...
                  game in order to improve your skills Enjoy this game in order
        ...
        <div className="my-4">
          <p className="ml-4 text-[#073946] font-medium text-2xl ">
